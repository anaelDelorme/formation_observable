...
-   Cliquer sur **Create your own** pour créer votre yaml
  ...
  deploy:
    ...
    steps:
      - name: Deploy to GitHub Pages
        ...
        with:
          # Spécifiez le sous-répertoire "formation" pour le déploiement.
...
Pour vérifier le déploiement, il faut aller dans l'onglet Actions du repo Github : 
